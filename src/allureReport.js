...
async function readAllureReport(reportPath, testEnvPath) {
	...
	if (failedTests.length > 0) {
		...
		color = Color.GREEN
		image = 'https://raw.githubusercontent.com/maritome/cypress-msteams-reporter/main/assets/images/passed.png'
	} else {
		title = 'Unknown Status'
		color = Color.BLACK
		image = 'https://raw.githubusercontent.com/maritome/cypress-msteams-reporter/main/assets/images/error.png'
		text =
